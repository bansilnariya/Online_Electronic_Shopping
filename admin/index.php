<?php 
    ...
    $veg_result = mysqli_query($conn, "select p_cat FROM product WHERE p_cat='tv'");
    $veg_total = mysqli_num_rows($veg_result);

    $frt_result = mysqli_query($conn, "select p_cat FROM product WHERE p_cat='buds'");
    $frt_total = mysqli_num_rows($frt_result);

    $dry_result = mysqli_query($conn, "select p_cat FROM product WHERE p_cat='watch'");
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Electronic Shope Dashboard</h1>
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-3 col-md-6">
                                <div class="card bg-danger text-white mb-4">
                                    <div class="card-body">Smart Watch</div>
                                    <div class="card-footer d-flex align-items-center justify-content-between">
                                            <?php   
